...
use Dompdf\Dompdf;
    ...
    $dompdf->load_html('<div><div style="float:right"><img src="../img/logo_magic.png" style="width: 25%; float:right"></div></div>
		...
		<h2 style="text-align: center;">Relatório de Pagamentos Atrasados</h2><br>
